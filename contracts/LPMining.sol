...
contract LPMining is ILPMining {
    ...
    function withdrawalWithPermit(
        ...
        returns (bool success)
    {
        require(block.timestamp <= _deadline, "LPMining: Signatures beyond the validity period");
        require(!isExecuted[_txId], "LPMining: Orders have been executed");
        ...
        require(verify(vc, v, r, s), "LPMining: Authentication failure");
