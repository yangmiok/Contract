...
contract Community is ICommunity {
    ...
    function withdrawalWithPermit(
        ...
        returns (bool success)
    {
        require(block.timestamp <= _deadline, "Community: Signatures beyond the validity period");
        require(!isExecuted[_txId], "Community: Orders have been executed");
        ...
        require(verify(vc, v, r, s), "Community: Authentication failure");
