...
contract Revenue is IRevenue {
    ...
    function withdrawalWithPermit(
        ...
        returns (bool success)
    {
        require(block.timestamp <= _deadline, "Revenue: Signatures beyond the validity period");
        require(!isExecuted[_txId], "Revenue: Orders have been executed");
        ...
        require(verify(vc, v, r, s), "Revenue: Authentication failure");
